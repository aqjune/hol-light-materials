...
let SIMP_EQUIV = prove(
  ...
  ARM_STUTTER_LEFT_TAC SIMP_EXEC (1--3) THEN
  (* Symbolically execute the right program only. "'" is the suffix of the
     state name. *)
  ARM_STUTTER_RIGHT_TAC SIMP2_EXEC (1--2) "'" THEN
